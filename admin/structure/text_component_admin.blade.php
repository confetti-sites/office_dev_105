...
<div id="{{ $model->getId() }}" class="w-full">
    <div class="min-h-[200px] w-full px-0 text-sm text-gray-800 bg-white border-0">
        {{ $model->get() }}
    </div>
...
{{--                                :class="{ 'bg-slate-500 text-white' : isActive('heading', { level: 1 }, updatedAt) }"--}}
{{--                                class="p-2 text-gray-500 rounded cursor-pointer hover:bg-slate-500 hover:text-white dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">--}}
...
{{--                                :class="{ 'bg-slate-500 text-white' : isActive('bold', updatedAt) }"--}}
{{--                                class="p-2 text-gray-500 rounded cursor-pointer hover:bg-slate-500 hover:text-white dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">--}}
{{--                            <svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg"--}}
{{--                                 viewBox="0 0 384 512">--}}
{{--                                <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->--}}
...
{{--                                :class="{ 'bg-slate-500 text-white' : isActive('italic', updatedAt) }"--}}
{{--                                class="p-2 text-gray-500 rounded cursor-pointer hover:bg-slate-500 hover:text-white dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">--}}
{{--                            <svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg"--}}
{{--                                 viewBox="0 0 384 512">--}}
{{--                                <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->--}}
...
{{--                        </button>--}}
{{--                        <button type="button" @click="setUnderline()"--}}
{{--                                :class="{ 'bg-slate-500 text-white' : isActive('underline', updatedAt) }"--}}
{{--                                class="p-2 text-gray-500 rounded cursor-pointer hover:bg-slate-500 hover:text-white dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">--}}
{{--                            <svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg"--}}
{{--                                 viewBox="0 0 448 512">--}}
{{--                                <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->--}}
...
{{--                                :class="{ 'bg-slate-500 text-white' : isActive('link', updatedAt) }"--}}
{{--                                class="p-2 text-gray-500 rounded cursor-pointer hover:bg-slate-500 hover:text-white dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">--}}
{{--                            <svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg"--}}
{{--                                 viewBox="0 0 640 512">--}}
{{--                                <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->--}}
...
{{--                        </button>--}}
{{--                        <button type="button" @click="setBulletList()"--}}
{{--                                :class="{ 'bg-slate-500 text-white' : isActive('bulletList', updatedAt) }"--}}
{{--                                class="p-2 text-gray-500 rounded cursor-pointer hover:bg-slate-500 hover:text-white dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">--}}
{{--                            <svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg"--}}
{{--                                 viewBox="0 0 512 512">--}}
{{--                                <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->--}}
...
{{--                        </button>--}}
{{--                        <button type="button" @click="setOrderedList()"--}}
{{--                                :class="{ 'bg-slate-500 text-white' : isActive('orderedList', updatedAt) }"--}}
{{--                                class="p-2 text-gray-500 rounded cursor-pointer hover:bg-slate-500 hover:text-white dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">--}}
{{--                            <svg class="w-4 h-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg"--}}
{{--                                 viewBox="0 0 512 512">--}}
{{--                                <!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2023 Fonticons, Inc. -->--}}
...
{{--                        class="p-2 text-gray-500 rounded cursor-pointer sm:ml-auto hover:bg-slate-500 hover:text-white dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">--}}
...
{{--                     style="position: absolute; inset: 0px auto auto 0px; margin: 0px; transform: translate3d(695.5px, 69px, 0px);"--}}
{{--                     data-popper-placement="bottom">--}}
{{--                    Show full screen--}}
{{--                    <div class="tooltip-arrow" data-popper-arrow=""--}}
{{--                         style="position: absolute; left: 0px; transform: translate3d(81px, 0px, 0px);"></div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </template>--}}
...
{{--            <div x-ref="element"--}}
{{--                 class="prose min-h-[200px] block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400"></div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--</div>--}}
