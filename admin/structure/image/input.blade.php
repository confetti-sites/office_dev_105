@php /** @var \Src\Structure\Image\ImageComponent $model */ @endphp
    ...
    <script type="module">
        ...
        customElements.define('image-component', class extends HTMLElement {
            ...
            uploading(target) {
                ...
                Media.upload(this.dataset.service_api, id, target, async (response) => {
                    window.dispatchEvent(new CustomEvent('state', {
                        detail: {
                            id: id + '.upload',
                            state: 'success',
                ...
                Storage.saveToLocalStorage(`/listener${id}.cropped`, {
                    ...
                    then: {
                        ...
                        'body': {
                            ...
                            'target_width': this.dataset.width_px > 0 ? this.dataset.width_px : this.defaultMaxWidth,
