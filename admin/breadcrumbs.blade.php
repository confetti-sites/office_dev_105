...
<nav class="flex px-5 py-4 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700"
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        <li class="inline-flex items-center">
            <a href="/admin"
               class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-emerald-800 dark:text-gray-400 dark:hover:text-white">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/admin{{ $currentId }}"
                       class="ms-1 text-sm font-medium text-gray-700 hover:text-emerald-800 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{ (new $item)->getComponent()->getLabel() }}</a>
                </div>
            </li>
        @endforeach
    </ol>
