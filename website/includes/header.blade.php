    ...
    <nav class="relative">
        <div class="flex items-center justify-between px-4 py-2">
            ...
            <div class="flex justify-end  md:justify-end">
                <!-- Hamburger Icon -->
                <button id="menu-toggle" type="button" aria-label="Toggle Navigation" class="text-gray-600 dark:text-gray-300 focus:outline-none md:hidden">
                ...
                <div class="js-menu hidden flex-col space-y-2 px-4 py-2 bg-white dark:bg-gray-900 dark:border-gray-700 md:flex md:flex-row md:space-y-0 md:space-x-4 md:border-none md:py-0">
                    <a href="/" class="block md:hidden transition hover:text-primary dark:hover:text-primaryLight px-4 py-2 md:py-2">Home</a>
                    <a href="/pricing" class="block relative transition hover:text-primary dark:hover:text-primaryLight px-4 py-2 md:py-2">Pricing</a>
                    <a href="/docs" class="block transition hover:text-primary dark:hover:text-primaryLight px-4 py-2 md:py-2">Docs</a>
                    @guest
                        <a href="https://tally.so/r/mK5kgK" class="relative ml-auto flex h-10 w-full items-center justify-center before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-95 dark:before:border-gray-700 dark:before:bg-primaryLight px-4">
